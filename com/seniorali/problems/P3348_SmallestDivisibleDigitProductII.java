...
/**
 * Problem: <a href="https://leetcode.com/problems/smallest-divisible-digit-product-ii">3348. Smallest Divisible Digit Product II</a><br/>
 * Difficulty: {@code Extremely Hard}
 * <p>
 * Topics: {@code Math}, {@code String}, {@code Backtracking}, {@code Greedy}, {@code Number Theory}
 */
public class P3348_SmallestDivisibleDigitProductII {
    private static final int[] primes;
    private static final int maxPrime;
    ...
    static void logNum(int[] primeCount, int num, int value) {
        if (num < '2') {
            return;
        }
    ...
    static String buildSuffix(int[] primeCount, int targetLength, char[] result) {
    ...
    static int getMinLength(int[] primeCount) {
